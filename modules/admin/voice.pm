...
sub init_admin_voice {
    ...
    sophia_event_privmsg_hook('sophia.voice', \&admin_voice, 'Voices the user/hostmask.', '', SOPHIA_ACL_VOICE | SOPHIA_ACL_AUTOVOICE);
...
sub deinit_admin_voice {
    ...
    sophia_event_privmsg_dehook 'sophia.voice';
