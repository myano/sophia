...
sub init_admin_kickban {
    ...
    sophia_event_privmsg_hook('admin.kickban', \&admin_kickban, 'Bans and kicks the user if bot is a chan op.', '', SOPHIA_ACL_OP | SOPHIA_ACL_AUTOOP);
...
sub deinit_admin_kickban {
    ...
    sophia_event_privmsg_dehook 'admin.kickban';
